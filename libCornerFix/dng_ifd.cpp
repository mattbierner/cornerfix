	...
	switch (tagCode)
		...
		case tcNewSubFileType:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("NewSubFileType: %s\n",
		...
		case tcImageWidth:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("ImageWidth: %u\n", (unsigned) fImageWidth);
				}
		...
		case tcImageLength:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("ImageLength: %u\n", (unsigned) fImageLength);
				}
		...
		case tcBitsPerSample:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("BitsPerSample:");
				}
			...
			for (j = 0; j < tagCount; j++)
				...
				if (gVerbose)
					{
					dng_local_printf::printf (" %u", (unsigned) x);
					}
		...
		case tcCompression:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Compression: %s\n",
		...
		case tcPhotometricInterpretation:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PhotometricInterpretation: %s\n",
		...
		case tcFillOrder:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("FillOrder: %u\n", (unsigned) fFillOrder);
				}
		...
		case tcOrientation:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Orientation: %s\n",
		...
		case tcSamplesPerPixel:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("SamplesPerPixel: %u\n", (unsigned) fSamplesPerPixel);
				}
		...
		case tcRowsPerStrip:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("RowsPerStrip: %u\n", (unsigned) fTileLength);
				}
		...
		case tcXResolution:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("XResolution: %0.2f\n", fXResolution);
				}
		...
		case tcYResolution:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("YResolution: %0.2f\n", fYResolution);
				}
		...
		case tcPlanarConfiguration:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("PlanarConfiguration: %u\n", (unsigned) fPlanarConfiguration);
				}
		...
		case tcResolutionUnit:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ResolutionUnit: %s\n",
		...
		case tcPredictor:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Predictor: %u\n", (unsigned) fPredictor);
		...
		case tcTileWidth:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("TileWidth: %u\n", (unsigned) fTileWidth);
				}
		...
		case tcTileLength:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("TileLength: %u\n", (unsigned) fTileLength);
				}
		...
		case tcExtraSamples:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("ExtraSamples:");
				}
		...
		case tcSampleFormat:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("SampleFormat:");
				}
		...
		case tcJPEGTables:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("JPEGTables: count = %u, offset = %u\n",
		...
		case tcJPEGInterchangeFormat:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("JPEGInterchangeFormat: %u\n",
		...
		case tcJPEGInterchangeFormatLength:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("JPEGInterchangeFormatLength: %u\n",
		...
		case tcYCbCrCoefficients:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("YCbCrCoefficients: R = %0.3f, G = %0.3f, B = %0.3f\n",
						fYCbCrCoefficientR,
						fYCbCrCoefficientG,
						fYCbCrCoefficientB);
		...
		case tcYCbCrSubSampling:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("YCbCrSubSampling: H = %u, V = %u\n",
		...
		case tcYCbCrPositioning:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("YCbCrPositioning: %u\n",
		...
		case tcReferenceBlackWhite:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ReferenceBlackWhite: %0.1f %0.1f %0.1f %0.1f %0.1f %0.1f\n",
		...
		case tcCFARepeatPatternDim:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CFARepeatPatternDim: Rows = %u, Cols = %u\n",
		...
		case tcCFAPattern:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CFAPattern:\n");
		...
		case tcCFAPlaneColor:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CFAPlaneColor:");
				
				for (j = 0; j < tagCount; j++)
					{
					
					dng_local_printf::printf (" %s", LookupCFAColor (fCFAPlaneColor [j]));
		...
		case tcCFALayout:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CFALayout: %s\n",
		...
		case tcBlackLevelRepeatDim:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BlackLevelRepeatDim: Rows = %u, Cols = %u\n",
		...
		case tcBlackLevel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BlackLevel:");
				...
				if (fBlackLevelRepeatRows == 1 &&
					...
					for (n = 0; n < fSamplesPerPixel; n++)
						{
						dng_local_printf::printf (" %0.2f", fBlackLevel [0] [0] [n]);
						}
					...
					for (n = 0; n < fSamplesPerPixel; n++)
						...
						if (fSamplesPerPixel > 1)
							{
							dng_local_printf::printf ("    Sample: %u\n", (unsigned) n);
							}
						...
						for (j = 0; j < fBlackLevelRepeatRows; j++)
							...
							for (k = 0; k < fBlackLevelRepeatCols; k++)
								...
								dng_local_printf::printf (" %8.2f", fBlackLevel [j] [k] [n]);
		...
		case tcWhiteLevel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("WhiteLevel:");
				
				for (j = 0; j < tagCount && j < kMaxSamplesPerPixel; j++)
					{

					dng_local_printf::printf (" %0.0f", fWhiteLevel [j]);
		...
		case tcDefaultScale:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DefaultScale: H = %0.4f V = %0.4f\n",
		...
		case tcDefaultCropOrigin:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DefaultCropOrigin: H = %0.2f V = %0.2f\n",
		...
		case tcDefaultCropSize:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DefaultCropSize: H = %0.2f V = %0.2f\n",
		...
		case tcBayerGreenSplit:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("BayerGreenSplit: %u\n", (unsigned) fBayerGreenSplit);
				}
		...
		case tcChromaBlurRadius:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ChromaBlurRadius: %0.2f\n",
		...
		case tcAntiAliasStrength:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AntiAliasStrength: %0.2f\n",
		...
		case tcBestQualityScale:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BestQualityScale: %0.4f\n",
		...
		case tcActiveArea:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ActiveArea: T = %d L = %d B = %d R = %d\n",
						(int) fActiveArea.t,
						(int) fActiveArea.l,
						(int) fActiveArea.b,
						(int) fActiveArea.r);
		...
		case tcMaskedAreas:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("MaskedAreas: %u\n", (unsigned) fMaskedAreaCount);
				
				for (j = 0; j < fMaskedAreaCount; j++)
					{
				
					dng_local_printf::printf ("    Area [%u]: T = %d L = %d B = %d R = %d\n",
							(unsigned) j,
							(int) fMaskedArea [j].t,
							(int) fMaskedArea [j].l,
							(int) fMaskedArea [j].b,
		...
		case tcPreviewApplicationName:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewApplicationName: ");
		...
		case tcPreviewApplicationVersion:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewApplicationVersion: ");
		...
		case tcPreviewSettingsName:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewSettingsName: ");
		...
		case tcPreviewSettingsDigest:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewSettingsDigest: ");
		...
		case tcPreviewColorSpace:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewColorSpace: %s\n",
		...
		case tcPreviewDateTime:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("PreviewDateTime: ");
		...
		case tcRowInterleaveFactor:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("RowInterleaveFactor: %u\n",
		...
		case tcSubTileBlockSize:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubTileBlockSize: rows = %u, cols = %u\n",
		...
		case tcOpcodeList1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OpcodeList1: count = %u, offset = %u\n",
		...
		case tcOpcodeList2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OpcodeList2: count = %u, offset = %u\n",
		...
		case tcOpcodeList3:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OpcodeList3: count = %u, offset = %u\n",
