	...
	switch (tagCode)
		...
		case tcImageDescription:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ImageDescription: ");
		...
		case tcSoftware:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Software: ");
		...
		case tcDateTime:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DateTime: ");
		...
		case tcArtist:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Artist: ");
		...
		case tcCopyright:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Copyright: ");
		...
		case tcTIFF_EP_StandardID:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("TIFF/EPStandardID: %u.%u.%u.%u\n",
						(unsigned) b0,
						(unsigned) b1, 
						(unsigned) b2,
						(unsigned) b3);
		...
		case tcKodakCameraSerialNumber:		// Kodak uses a very similar tag.
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("%s: ", LookupTagCode (parentCode, tagCode));
		...
		case tcLensInfo:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("LensInfo: ");
				
				real64 minFL = fLensInfo [0].As_real64 ();
				real64 maxFL = fLensInfo [1].As_real64 ();
				
				if (minFL == maxFL)
					dng_local_printf::printf ("%0.1f mm", minFL);
				else
					dng_local_printf::printf ("%0.1f-%0.1f mm", minFL, maxFL);
				...
				if (fLensInfo [2].d)
					...
					if (minFS == maxFS)
						dng_local_printf::printf (" f/%0.1f", minFS);
					else
						dng_local_printf::printf (" f/%0.1f-%0.1f", minFS, maxFS);
	...
	switch (tagCode)
		...
		case tcFocalPlaneXResolution:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneXResolution: %0.4f\n",
		...
		case tcFocalPlaneYResolution:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneYResolution: %0.4f\n",
		...
		case tcFocalPlaneResolutionUnit:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneResolutionUnit: %s\n",
		...
		case tcSensingMethod:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SensingMethod: %s\n",
	...
	switch (tagCode)
		...
		case tcBatteryLevel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BatteryLevel: ");
				...
				if (tagType == ttAscii)
					...
					dng_local_printf::printf ("%0.2f", fBatteryLevelR.As_real64 ());
		...
		case tcExposureTime:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExposureTime: ");
		...
		case tcFNumber:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FNumber: f/%0.1f\n",
						fs.As_real64 ());
		...
		case tcExposureProgram:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExposureProgram: %s\n",
		...
		case tcISOSpeedRatings:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ISOSpeedRatings:");
				
				for (uint32 j = 0; j < tagCount && j < 3; j++)
					{
					
					dng_local_printf::printf (" %u", (unsigned) fISOSpeedRatings [j]);
		...
		case tcTimeZoneOffset:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("TimeZoneOffset: DateTimeOriginal = %d", 
						(int) zoneOriginal.ExactHourOffset ());
						
				if (tagCount >= 2)
					{
				
					dng_local_printf::printf (", DateTime = %d",
		...
		case tcSelfTimerMode:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SelfTimerMode: ");
				
				if (fSelfTimerMode)
					{
					
					dng_local_printf::printf ("%u sec", (unsigned) fSelfTimerMode);
		...
		case tcExifVersion:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExifVersion: %0.2f\n", x);
		...
		case tcDateTimeOriginal:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DateTimeOriginal: ");
		...
		case tcDateTimeDigitized:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DateTimeDigitized: ");
		...
		case tcComponentsConfiguration:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ComponentsConfiguration: %s %s %s %s\n",
						LookupComponent (b0),
						LookupComponent (b1),
						LookupComponent (b2),
						LookupComponent (b3));
		...
		case tcCompressedBitsPerPixel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CompressedBitsPerPixel: %0.2f\n",
		...
		case tcShutterSpeedValue:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ShutterSpeedValue: ");
		...
		case tcApertureValue:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ApertureValue: f/%0.1f\n", x);
		...
		case tcBrightnessValue:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BrightnessValue: %0.2f\n",
		...
		case tcExposureBiasValue:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExposureBiasValue: %0.2f\n",
		...
		case tcMaxApertureValue:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("MaxApertureValue: f/%0.1f\n", x);
		...
		case tcSubjectDistance:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubjectDistance: %u/%u\n",
		...
		case tcMeteringMode:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("MeteringMode: %s\n",
		...
		case tcLightSource:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("LightSource: %s\n",
		...
		case tcFlash:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Flash: %u\n", (unsigned) fFlash);
				
				if ((fFlash >> 5) & 1)
					{
					dng_local_printf::printf ("    No flash function\n");
					}
					...
					if (fFlash & 0x1)
						...
						dng_local_printf::printf ("    Flash fired\n");
						
						switch ((fFlash >> 1) & 0x3)
							{
							
							case 2:
								dng_local_printf::printf ("    Strobe return light not detected\n");
								break;
								
							case 3:
								dng_local_printf::printf ("    Strobe return light detected\n");
								break;
						...
						{
						dng_local_printf::printf ("    Flash did not fire\n");
						}
					...
					switch ((fFlash >> 3) & 0x3)
						...
						case 1:
							dng_local_printf::printf ("    Compulsory flash firing\n");
							break;
							
						case 2:
							dng_local_printf::printf ("    Compulsory flash suppression\n");
							break;
							
						case 3:
							dng_local_printf::printf ("    Auto mode\n");
							break;
					...
					if ((fFlash >> 6) & 1)
						{
						dng_local_printf::printf ("    Red-eye reduction supported\n");
						}
		...
		case tcFocalLength:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalLength: %0.1f mm\n",
		...
		case tcImageNumber:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("ImageNumber: %u\n", (unsigned) fImageNumber);
				}
		...
		case tcExposureIndexExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("%s: ISO %0.1f\n",
		...
		case tcUserComment:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("UserComment: ");
		...
		case tcSubsecTime:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubsecTime: ");
		...
		case tcSubsecTimeOriginal:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubsecTimeOriginal: ");
		...
		case tcSubsecTimeDigitized:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubsecTimeDigitized: ");
		...
		case tcFlashPixVersion:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FlashPixVersion: %0.2f\n", x);
		...
		case tcColorSpace:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ColorSpace: %s\n",
		...
		case tcPixelXDimension:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("PixelXDimension: %u\n", (unsigned) fPixelXDimension);
				}
		...
		case tcPixelYDimension:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("PixelYDimension: %u\n", (unsigned) fPixelYDimension);
				}
		...
		case tcFocalPlaneXResolutionExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneXResolutionExif: %0.4f\n",
						fFocalPlaneXResolution.As_real64 ());
		...
		case tcFocalPlaneYResolutionExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneYResolutionExif: %0.4f\n",
						fFocalPlaneYResolution.As_real64 ());
		...
		case tcFocalPlaneResolutionUnitExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalPlaneResolutionUnitExif: %s\n",
					    LookupResolutionUnit (fFocalPlaneResolutionUnit));
		...
		case tcSensingMethodExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SensingMethodExif: %s\n",
						LookupSensingMethod (fSensingMethod));
		...
		case tcFileSource:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FileSource: %s\n",
		...
		case tcSceneType:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SceneType: %s\n",
		...
		case tcCFAPatternExif:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CFAPatternExif:\n");
				...
				for (uint32 j = 0; j < fCFARepeatPatternRows; j++)
					...
					for (uint32 k = 0; k < fCFARepeatPatternCols; k++)
						...
						dng_local_printf::printf ("%s", name);
		...
		case tcCustomRendered:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CustomRendered: %s\n",
		...
		case tcExposureMode:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExposureMode: %s\n",
		...
		case tcWhiteBalance:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("WhiteBalance: %s\n",
		...
		case tcDigitalZoomRatio:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DigitalZoomRatio: ");
				
				if (fDigitalZoomRatio.n == 0 ||
					fDigitalZoomRatio.d == 0)
					{
					
					dng_local_printf::printf ("Not used\n");
		...
		case tcFocalLengthIn35mmFilm:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("FocalLengthIn35mmFilm: %u mm\n",
		...
		case tcSceneCaptureType:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SceneCaptureType: %s\n",
		...
		case tcGainControl:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("GainControl: %s\n",
		...
		case tcContrast:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Contrast: %s\n",
		...
		case tcSaturation:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Saturation: %s\n",
		...
		case tcSharpness:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Sharpness: %s\n",
		...
		case tcSubjectDistanceRange:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("SubjectDistanceRange: %s\n",
		...
		case tcSubjectLocation:
			...
			if (gVerbose)
				...
				for (uint32 j = 0; j < fSubjectAreaCount; j++)
					...
					dng_local_printf::printf (" %u", (unsigned) fSubjectArea [j]);
		...
		case tcGamma:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("Gamma: %0.2f\n",
						fGamma.As_real64 ());
		...
		case tcImageUniqueID:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ImageUniqueID: ");
...
bool dng_exif::Parse_gps (dng_stream &stream,
	...
	switch (tagCode)
		...
		case tcGPSVersionID:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("GPSVersionID: %u.%u.%u.%u\n",
						(unsigned) b0,
						(unsigned) b1,
						(unsigned) b2,
						(unsigned) b3);
			...
			if (gVerbose)
				...
				for (uint32 j = 0; j < 3; j++)
					...
					if (u [j].d == 0)
						...
						dng_local_printf::printf (" %0.4f", u [j].As_real64 ());
		...
		case tcGPSAltitudeRef:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("GPSAltitudeRef: ");
				
				switch (fGPSAltitudeRef)
					{
					
					case 0:
						dng_local_printf::printf ("Sea level");
						break;
						
					case 1:
						dng_local_printf::printf ("Sea level reference (negative value)");
						break;
						
					default:
						dng_local_printf::printf ("%u", (unsigned) fGPSAltitudeRef);
						break;
			...
			*u = stream.TagValue_urational (tagType);
			...
			if (gVerbose)
				...
				if (u->d == 0)
					...
					dng_local_printf::printf (" %0.4f", u->As_real64 ());
		...
		case tcGPSDifferential:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("GPSDifferential: ");
				
				switch (fGPSDifferential)
					{
					
					case 0:
						dng_local_printf::printf ("Measurement without differential correction");
						break;
						
					case 1:
						dng_local_printf::printf ("Differential correction applied");
						break;
						
					default:
						dng_local_printf::printf ("%u", (unsigned) fGPSDifferential);
	...
	switch (tagCode)
		...
		case tcInteroperabilityIndex:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("InteroperabilityIndex: ");
		...
		case tcInteroperabilityVersion:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("InteroperabilityVersion: %0.2f\n", x);
		...
		case tcRelatedImageFileFormat:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("RelatedImageFileFormat: ");
		...
		case tcRelatedImageWidth:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("RelatedImageWidth: %u\n", (unsigned) fRelatedImageWidth);
				}
		...
		case tcRelatedImageLength:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("RelatedImageLength: %u\n", (unsigned) fRelatedImageLength);
				}
