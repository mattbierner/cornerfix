	...
	switch (tagCode)
		...
		case tcCalibrationIlluminant1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CalibrationIlluminant1: %s\n",
		...
		case tcCalibrationIlluminant2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CalibrationIlluminant2: %s\n",
		...
		case tcColorMatrix1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ColorMatrix1:\n");
		...
		case tcColorMatrix2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ColorMatrix2:\n");
		...
		case tcForwardMatrix1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ForwardMatrix1:\n");
		...
		case tcForwardMatrix2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ForwardMatrix2:\n");
		...
		case tcReductionMatrix1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ReductionMatrix1:\n");
		...
		case tcReductionMatrix2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ReductionMatrix2:\n");
		...
		case tcProfileCalibrationSignature:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileCalibrationSignature: ");
		...
		case tcProfileName:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileName: ");
		...
		case tcProfileCopyright:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileCopyright: ");
		...
		case tcProfileEmbedPolicy:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileEmbedPolicy: %s\n", policy);
		...
		case tcProfileHueSatMapDims:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileHueSatMapDims: Hues = %u, Sats = %u, Vals = %u\n",
		...
		case tcProfileHueSatMapData1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileHueSatMapData1:\n");
		...
		case tcProfileHueSatMapData2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileHueSatMapData2:\n");
		...
		case tcProfileLookTableDims:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileLookTableDims: Hues = %u, Sats = %u, Vals = %u\n",
		...
		case tcProfileLookTableData:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ProfileLookTableData:\n");
		...
		case tcUniqueCameraModel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("UniqueCameraModel: ");
	...
	switch (tagCode)
		...
		case tcXMP:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("XMP: Count = %u, Offset = %u\n",
						(unsigned) fXMPCount,
						(unsigned) fXMPOffset);
		...
		case tcIPTC_NAA:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("IPTC/NAA: Count = %u, Offset = %u\n",
				...
				// Method 1: Counting all bytes (this is correct).
					...
					dng_local_printf::printf ("IPTCDigest: ");
				...
				// Method 2: Ignoring zero padding.
					...
					if (removed != 0)
						...
						dng_local_printf::printf ("IPTCDigest (ignoring zero padding): ");
		...
		case tcExifIFD:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("ExifIFD: %u\n", (unsigned) fExifIFD);
				}
		...
		case tcGPSInfo:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("GPSInfo: %u\n", (unsigned) fGPSInfo);
				}
		...
		case tcKodakDCRPrivateIFD:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("KodakDCRPrivateIFD: %u\n", (unsigned) fKodakDCRPrivateIFD);
				}
		...
		case tcKodakKDCPrivateIFD:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("KodakKDCPrivateIFD: %u\n", (unsigned) fKodakKDCPrivateIFD);
				}
		...
		case tcDNGVersion:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("DNGVersion: %u.%u.%u.%u\n",
						(unsigned) b0,
						(unsigned) b1,
						(unsigned) b2,
						(unsigned) b3);
		...
		case tcDNGBackwardVersion:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("DNGBackwardVersion: %u.%u.%u.%u\n", 
						(unsigned) b0, 
						(unsigned) b1, 
						(unsigned) b2, 
						(unsigned) b3);
		...
		case tcLocalizedCameraModel:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("LocalizedCameraModel: ");
		...
		case tcCameraCalibration1:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CameraCalibration1:\n");
		...
		case tcCameraCalibration2:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CameraCalibration2:\n");
		...
		case tcCameraCalibrationSignature:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CameraCalibrationSignature: ");
		...
		case tcAnalogBalance:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AnalogBalance:");
		...
		case tcAsShotNeutral:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AsShotNeutral:");
		...
		case tcAsShotWhiteXY:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AsShotWhiteXY: %0.4f %0.4f\n",
						fAsShotWhiteXY.x,
						fAsShotWhiteXY.y);
		...
		case tcBaselineExposure:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BaselineExposure: %+0.2f\n",
		...
		case tcBaselineNoise:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BaselineNoise: %0.2f\n",
		...
		case tcNoiseReductionApplied:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("NoiseReductionApplied: %u/%u\n",
		...
		case tcNoiseProfile:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("NoiseProfile:\n");
				
				dng_local_printf::printf ("  Planes: %u\n", numPlanes);
					
				for (uint32 plane = 0; plane < numPlanes; plane++)
					{

					dng_local_printf::printf ("  Noise function for plane %u: scale = %.8lf, offset = %.8lf\n",
							plane,
		...
		case tcBaselineSharpness:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("BaselineSharpness: %0.2f\n",
		...
		case tcLinearResponseLimit:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("LinearResponseLimit: %0.2f\n",
		...
		case tcShadowScale:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ShadowScale: %0.4f\n",
		...
		case tcDNGPrivateData:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("DNGPrivateData: Count = %u, Offset = %u\n",
		...
		case tcMakerNoteSafety:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("MakerNoteSafety: %s\n",
		...
		case tcRawImageDigest:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("RawImageDigest: ");
		...
		case tcRawDataUniqueID:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("RawDataUniqueID: ");
		...
		case tcOriginalRawFileName:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OriginalRawFileName: ");
		...
		case tcOriginalRawFileData:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OriginalRawFileData: Count = %u, Offset = %u\n",
		...
		case tcOriginalRawFileDigest:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("OriginalRawFileDigest: ");
		...
		case tcAsShotICCProfile:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AsShotICCProfile: Count = %u, Offset = %u\n",
		...
		case tcAsShotPreProfileMatrix:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AsShotPreProfileMatrix:\n");
		...
		case tcCurrentICCProfile:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CurrentICCProfile: Count = %u, Offset = %u\n",
		...
		case tcCurrentPreProfileMatrix:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("CurrentPreProfileMatrix:\n");
		...
		case tcColorimetricReference:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ColorimetricReference: %s\n",
		...
		case tcExtraCameraProfiles:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("ExtraCameraProfiles: %u\n", (unsigned) tagCount);
		...
		case tcAsShotProfileName:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("AsShotProfileName: ");
	...
	switch (tagCode)
		...
		case tcMakerNote:
			...
			if (gVerbose)
				...
				dng_local_printf::printf ("MakerNote: Count = %u, Offset = %u\n",
		...
		case tcInteroperabilityIFD:
			...
			if (gVerbose)
				{
				dng_local_printf::printf ("InteroperabilityIFD: %u\n", (unsigned) fInteroperabilityIFD);
				}
