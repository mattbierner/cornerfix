...
class dng_host
	...
	public:
		...
		/// Factory method for dng_makernotes class. Can be used to customize allocation or to ensure a derived class is used instead of dng_ifd.

		virtual dng_makernotes * Make_dng_makernotes ();
